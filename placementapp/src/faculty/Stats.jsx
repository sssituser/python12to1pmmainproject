    ...
    const fetchStudentData = async () => {
      try {
        ...
        if (studentsRes.ok) {
          ...
          // Transform data to match expected format and filter by role
          const transformedStudents = data
            .filter(s => (s.role || s.user?.role || "").toLowerCase() === 'student')
            .map((student) => {
      ...
      try {
        ...
        console.log("Stats fetch process failed");
      }
