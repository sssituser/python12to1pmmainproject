...
from .views.exam_views import (
    get_questions, create_question, start_exam_session, submit_answer,
...
urlpatterns = [
    ...
    path('exam-reports/daily/', exam_reports_api),
    ...
    path('exam-settings/', exam_settings_api, name='exam_settings'),
    path('leaderboard/', leaderboard_api),

    # ── Exam Results URLs ─────────────────────────────────────────────────────
    path('user-combined-results/', user_combined_results_api, name='user_combined_results'),
    path('all-exam-results/', user_combined_results_api, name='all_exam_results'),

    # ── Professional Exam Ecosystem URLs ──────────────────────────────────────
    ...
    path('update-user-status/<int:student_id>/', toggle_student_status_api),
