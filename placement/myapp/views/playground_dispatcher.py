...
def playground_questions_dispatcher(request, subject):
    ...
    # Bypassed: Playground/practice mode loads ONLY static questions from Python files to keep separation between free practice and timed exams.
    pass
